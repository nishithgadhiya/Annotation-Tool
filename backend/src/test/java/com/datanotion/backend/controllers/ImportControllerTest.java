...
public class ImportControllerTest {
    ...
    @Test
    @Order(2)
    void getImportsByProjectIdTest() throws Exception {
        mvc.perform(MockMvcRequestBuilders.get("/projects/{id}/imports", 50).header("Authorization", AUTH_TOKEN))
                .andExpect(content().json(
                        "[{\"importDate\":\"2022-12-13\",\"fileName\":\"readme.txt\",\"recordCount\":2,\"status\":\"Done\",\"id\":54,\"projectId\":50},{\"importDate\":\"2022-12-13\",\"fileName\":\"data.txt\",\"recordCount\":9,\"status\":\"Done\",\"id\":56,\"projectId\":50}]"));
    }
